...
// http://13.125.129.82/apiV1/babyHospList.php?wgs84Lon=128.9152527&wgs84Lat=37.7679253&page=1&per_page=50&distance=10&openFlag=ON
...
if ($wgs84Lon != "" && $wgs84Lat != "")
{
	...
	$WhereSql = " WHERE status_code = '1' AND baby_flag = 'Y' ";
...
$json_array_result = array(
	...
	, 'STATUSMSG'    => (string)($StatusCode == "2" ? "반경 내 해당하는 달빛어린이병원이 없습니다." : $_utilLibrary->errorCheckReturnMsg($StatusCode) )
	, 'TPAGE' 	     => (string)$TPage
	, 'LIST'         => $listArray
);
