...
// http://13.125.129.82/apiV1/pharmacyList.php?wgs84Lon=128.9152527&wgs84Lat=37.7679253&page=1&per_page=50&distance=10&openFlag=ON
...
$json_array_result = array(
	...
	, 'STATUSMSG'    => (string)($StatusCode == "2" ? "반경 내 해당하는 약국이 없습니다." : $_utilLibrary->errorCheckReturnMsg($StatusCode) )
	, 'TPAGE' 	     => (string)$TPage
	, 'LIST'         => $dataRSArray
);
